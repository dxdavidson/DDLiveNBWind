...
app.get('/api/weatherforecast', async (req, res) => {
  try {
    const url = 'https://api.open-meteo.com/v1/forecast?latitude=56.058&longitude=-2.722&hourly=wind_speed_10m,wind_direction_10m,precipitation_probability,temperature_2m,weather_code&wind_speed_unit=mph';
